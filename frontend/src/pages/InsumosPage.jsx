...
export default function InsumosPage() {
  ...
  const fetchInsumos = async () => {
    try {
      const res = await fetch('http://localhost:8000/api/v1/insumos/', {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const data = await res.json();
      if (!res.ok) throw new Error(data.detail || 'Error al crear el insumo');
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="bg-white p-6 rounded-xl shadow-md border border-slate-200">
              <h2 className="text-xl font-semibold text-slate-800 mb-4">Nuevo Insumo</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input 
                    ...
                    placeholder="Fertilizante NPK 15-15-15"
                  />
                </div>
                <div>
          ...
          <div className="md:col-span-2">
            <div className="bg-white p-6 rounded-xl shadow-md border border-slate-200">
              ...
              {loading ? (
                ...
                <p className="text-slate-400 italic">Bodega vacía. Registra tu primer insumo.</p>
              ) : (
